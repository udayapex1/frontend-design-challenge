...
import {
  Search, SlidersHorizontal, Columns2, Plus,
  RefreshCw, Sun, Moon, Menu, House,
} from "lucide-react";
                ...
                <table className="w-full text-left text-sm min-w-[640px]">
                  ...
                  <tbody>
                    {filteredScans.map((scan) => (
                      ...
                      >
                        <td className="px-4 py-3 font-semibold text-gray-900 dark:text-white">{scan.name}</td>
                        <td className="px-4 py-3 text-gray-500 dark:text-gray-400">{scan.type}</td>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-gray-500 dark:text-gray-400 whitespace-nowrap">{scan.progress}%</span>
                          </div>
                        </td>
                        <td className="px-4 py-3">
                          <div className="flex gap-1">
                            {[
                              ...
                              v.val != null ? (
                                <span key={i} className={`${v.bg} text-white text-[11px] font-bold w-7 h-7 flex items-center justify-center rounded`}>
                                  {v.val}
                                </span>
                              ) : null
                            )}
                        ...
                        <td className="px-4 py-3 text-gray-400 text-right whitespace-nowrap">{scan.lastScan}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
